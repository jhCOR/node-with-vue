...
var detaileditor = function(req, res) {
	console.log('post 모듈 안에 있는 detaileditor 호출됨.');
	if(req.isAuthenticated()){
		res.render('editorForDetail.ejs', {message: req.flash('loginMessage')});
	}else{
...
module.exports.detaileditor = detaileditor;
